...
import { Column, Profile } from '~components/roster2';
...
export const defaultColumns: Column[] = [
  ...
  },
  {
    ...
    render: (_: string, profile: Profile, canOperate: boolean, userType: string, onClick: any) => {
      ...
      return <Icon type={type} className={cls} iconhover={canOperate} onClick={onClick} />;
    },
  },
  {
    ...
    render: (_: string, profile: Profile, canOperate: boolean, userType: string, onClick: any) => {
      const type =
        userType + '-' + (!!profile.whiteboardGranted === true ? 'authorized' : 'whiteboard');
      const operateStatus = !!canOperate === true ? 'operate-status' : 'un-operate-status';
  ...
  },
  {
    ...
    render: (_: string, profile: Profile, canOperate: boolean, userType: string, onClick: any) => {
      ...
      return <Icon type={'exit'} className={cls} iconhover={canOperate} onClick={onClick} />;
    },
  },
];
