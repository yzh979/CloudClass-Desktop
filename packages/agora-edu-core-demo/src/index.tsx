...
let params: AppStoreInitParams = {
  config: {
    ...
    rtmUid: 'user01',
    rtmToken:
      '006f488493d1886435f963dfb3d95984fd4IAB8eJsKCUuCV98dNRYolF6KEBt1IgDkMZ4YjhoW63rU+ggqSoEAAAAAEABRcvWnxmm3YAEA6APGabdg',
    recordUrl: '',
    extApps: [],
    widgets: {
      ...{
        // 'chat':new AgoraChatWidget()
      },
      ...{},
    },
    userFlexProperties: {},
