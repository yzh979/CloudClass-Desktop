...
export interface EduClassroomManagerEventHandlers {
   ...
   */
  'local-user-updated': (evt: {
    user: EduUserData;
    operator: OperatorUser;
    cause: CauseType;
  }) => void;
  'local-user-removed': (evt: {
    user: EduUserData;
    type: number;
    operator: OperatorUser;
    cause: CauseType;
  ...
  'remote-stream-added': (evt: {
    stream: EduStream;
    operator: OperatorUser;
    cause: CauseType;
  }) => void;
  'remote-stream-removed': (evt: {
    stream: EduStream;
    operator: OperatorUser;
    cause: CauseType;
  }) => void;
  'remote-stream-updated': (evt: {
    stream: EduStream;
    operator: OperatorUser;
    cause: CauseType;
  }) => void;
